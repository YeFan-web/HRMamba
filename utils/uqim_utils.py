...
if __name__ == '__main__':
    img = cv2.imread('/home/ai04/桌面/master_fanye/under_water_enhance/evaluation/OutputImages/EUVP_test/Inp_CLAHE/test_p0__CLAHE.jpg')
    uiqm, uicm, uism, uiconm = getUIQM(img)
    print("UIQM:", uiqm)
    print("UICM:", uicm)
    print("UISM:", uism)
    print("UICONM:", uiconm)